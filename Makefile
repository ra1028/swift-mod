...
format:
	swift run -c release swift-format --configuration .swift-format.json -i -r -m format $(SWIFT_FORMAT_PATHS)

lint:
	swift run -c release swift-format --configuration .swift-format.json -r -m lint $(SWIFT_FORMAT_PATHS)
